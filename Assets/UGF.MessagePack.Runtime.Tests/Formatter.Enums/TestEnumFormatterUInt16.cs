...
{
    public class TestEnumFormatterUInt16
    {
        private enum Target : ushort
        {
            Value
        }
        ...
        public void Serialize()
        {
            ...
            var formatter = new EnumFormatterUInt16<Target>(new MessagePackProvider(), MessagePackContext.Empty);
