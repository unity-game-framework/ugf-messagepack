...
{
    public class TestEnumFormatterSByte
    {
        private enum Target : sbyte
        {
            Value
        }
        ...
        public void Serialize()
        {
            ...
            var formatter = new EnumFormatterSByte<Target>(new MessagePackProvider(), MessagePackContext.Empty);
