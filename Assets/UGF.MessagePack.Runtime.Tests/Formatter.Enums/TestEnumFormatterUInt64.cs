...
{
    public class TestEnumFormatterUInt64
    {
        private enum Target : ulong
        {
            Value
        }
        ...
        public void Serialize()
        {
            ...
            var formatter = new EnumFormatterUInt64<Target>(new MessagePackProvider(), MessagePackContext.Empty);
